...
"""
# --- Variables/Arrays --- #
ionName = (("Li",1), ("Mg",2), ("Ca",2), ("Sr",2),("Ba",2),("Fe",2),("Hg",2), ("Pb",2), ("F",1), ("Cl",1), ("Br",1), ("I",1), ("Cu",1), ("Ag",1), ("Tl",1), ("SO4",2), ("Ra",2), ("NH4",1), ("NO3",1), ("ClO4",1), ("CH3COO",1), ("RbClO4",1), ("CsClO4",1), ("AgCH3COO",1), ("Hg2(CH3COO)2",1),("H",1),("Na",1), ("K",1), ("Rb",1), ("Cs",1), ("Fr",1))
...
#find limiting reagent
    ...
    print(molesNegReagent)
    print(molesPosReagent)
    print(negSolution)
    print(positiveSolution)
